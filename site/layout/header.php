...
<head>
    <title>Trang chủ - The Bloom Studio</title>
    <meta charset="utf-8">
    ...
    <header>
        ...
        <div class="top-navbar container-fluid">
            <div class="menu-mb">
                ...
                <a class="<?= $a == 'delivery' ? 'active' : '' ?>" href="?c=policy&a=delivery">Chính sách giao hàng</a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 hidden-sm hidden-xs" style="padding-left: 175px;">
                ...
                <div class="col-lg-4 col-md-4 hotline-search">
                    <div>
                        <p class="hotline-phone"><span><strong>Hotline: </strong><a
                                    href="tel:0965.337.849">0965.337.849</a></span></p>
                        <p class="hotline-email"><span><strong>Email: </strong><a
                                    href="mailto:nguyenducthanhlong159@gmail.com">nguyenducthanhlong159@gmail.com</a></span>
                        </p>
                    </div>
                    <form class="header-form" action="">
                        <div class="input-group" style="margin-top: 0px; margin-bottom: 15px;">
    ...
    <nav class="navbar navbar-default desktop-menu">
        <div class="container">
            <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                ...
                <li class="<?= $a == 'payment' ? 'active' : '' ?>"><a href="?c=policy&a=payment">Chính sách thanh
                        toán</a>
                </li>
                <li class="<?= $a == 'delivery' ? 'active' : '' ?>"><a href="?c=policy&a=delivery">Chính sách giao
                        hàng</a></li>
