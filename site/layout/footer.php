        ...
        <div class="col-xs-12">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="?c=product">Hoa sinh nhật </a></li>
                                <li><a href="?c=product">Hoa tình yêu</a></li>
                                <li><a href="?c=product">Hoa khai trương </a></li>
                                <li><a href="?c=product">Hoa cưới</a></li>
                                <li><a href="?c=product">Hoa ngày lễ </a></li>
                                <li><a href="?c=product">Hoa sự kiện </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="?c=policy&a=return">Chính sách đổi trả</a></li>
                                <li><a href="?c=policy&a=payment">Chính sách thanh toán</a></li>
                                <li><a href="?c=policy&a=delivery">Chính sách giao hàng </a></li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li>Phone: 0965.337.849</li>
                                <li><a href="mailto:nguyenducthanhlong159@gmail.com">Mail:
                                        nguyenducthanhlong159@gmail.com</a></li>
                            </ul>
                ...
                <p style="text-align: center">
                    Copyright ©2025, The Bloom Studio. All rights reserved.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-color">
                ...
                // http://godashop.com/site/index.php?.c=auth&a=loginGoogle
                ...
                <div class="text-center">
                    <a class="btn btn-primary google-login" href="<?= $loginUrl     ?>"><i
                            class="fab fa-google"></i></i> Đăng
                        nhập
                        bằng Google</a>
                    <!-- Facebook login
